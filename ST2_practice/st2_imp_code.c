...
//     gets(str); // Warning: unsafe, use fgets in real programs
//     words[i] = strtok(str, " ");
//     while (words[i]) words[++i] = strtok(NULL, " ");
//     for (n = i - 1; n >= 0; n--) printf("%s ", words[n]);
// }

// reverse alphabets of string
